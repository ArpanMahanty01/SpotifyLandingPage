    ...
    <header className={NavStyle.header}>
      <div className={NavStyle.bar}>
        <div className={NavStyle.logo}>
          <Link to="/">
            <span>
            <svg viewBox='0 0 63 20' xmlns='http://www.w3.org/2000/svg'>
              <g fillRule='evenodd'>
        ...
        <button onClick={handleClick} className={showSide?`${NavStyle.button} ${NavStyle.active}`:`${NavStyle.button} ${NavStyle.inactive}`}>
          <svg fill='white' className='' viewBox='0 0 100 100' width={250}>
            <rect className={`${NavStyle.line} ${NavStyle.top}`} width={80} height={10} x={10} y={25} rx={5}></rect>
            <rect className={`${NavStyle.line} ${NavStyle.middle}`} width={80} height={10} x={10} y={45} rx={5}></rect>
            <rect className={`${NavStyle.line} ${NavStyle.bottom}`} width={80} height={10} x={10} y={65} rx={5}></rect>
          </svg>
        </button> 
        <div className={NavStyle.overlay}>
          <nav className={NavStyle.mobileNav}>
            <ul>
              <li className={NavStyle.Premium}>
                <a href="">Premium</a>
              </li>
              <li className={NavStyle.Support}>
                <a href="">Support</a>
              </li>
              <li className={NavStyle.Download}>
                <a href="">Download</a>
              </li>
              <li className={NavStyle.HgSeparator}></li>
              <li className={NavStyle.SignUp}>
                <a href="">Sign up</a>
              </li>
              <li className={NavStyle.SignIn}>
                <a href="">Sign in</a>
              </li>
            </ul>
            <div className={NavStyle.hblogo}></div>
          </nav>
        </div>
      </div>
    </header>

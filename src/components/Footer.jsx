        ...
        <nav className={FooterStyles.footerNav}>
          ...
          <div className={FooterStyles.social}>
            ...
            <li className={FooterStyles.instagram}>
              <a href="https://instagram.com/spotify" title="Instagram"target="_blank" rel="noopener noreferrer">
            ...
            <li className={FooterStyles.facebook}><a href="" title="Facebook"  target="_blank" rel="noopener noreferrer">
              <span role="img" aria-label="Facebook"></span>
              </a> 
            </li>
            </ul>
          </div>
          <div className={FooterStyles.bottomLeft}>
            <a href="" id="">
          ...
          <div className={FooterStyles.bottomRight}>
            <ul>
            <li>
              <div><a href="" id="">Legal</a></div> 
            </li>
            <li>
              <div><a href="" id="">Privacy Center</a> </div> 
            </li>
            <li>
              <div><a href="" id="">Privacy Policy</a> </div> 
            </li>
            <li>
              <div><a href="" id="">Cookies</a> </div> 
            </li>
            <li>
              <div><a href="" id="">About Ads</a> </div> 
            </li>
            </ul>
